  ...
  return (
    <>
      ...
      <div className="allPostsContainer">
        ...
        <ModalEditPost titleValue={titleEdit} onChangeTitle={(e: any) => {
          setTitleEdit(e.target.value)
          setIsWarning('')
        }} descriptionValue={descriptionEdit} onChangeDescription={(e: any) => {
          setDescriptionEdit(e.target.value)
          setIsWarning('')
        }
        } isOpen={isOpenEdit} onClick={handleEdit} descriptionError={isWarning} onRequestClose={() => {
          setIsWarning('')
          setPostID('')
          setTitleEdit('')
          setDescriptionEdit('')
